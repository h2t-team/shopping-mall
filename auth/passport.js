...
passport.use(
    new GoogleStrategy({
            ...
            callbackURL: 'http://shopping-mall-h2t-team.herokuapp.com/auth/google/callback',
            proxy: true
        },
...
passport.use(new FacebookStrategy({
    ...
    callbackURL: "http://shopping-mall-h2t-team.herokuapp.com/auth/facebook/callback",
    proxy: true,
